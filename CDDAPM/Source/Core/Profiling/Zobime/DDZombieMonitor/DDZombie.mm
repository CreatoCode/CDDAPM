...
#ifndef TrackThreadStack
@dynamic threadStack;
#endif

-(DDThreadStack *)threadStack
{
    return nil;
}
...
- (void)handleZombieWithSelector:(NSString *)selectorName zombieStack:(DDThreadStack *)zombieStack deallocStack:(DDThreadStack *)deallocStack
{
    @autoreleasepool {
        if ([DDZombieMonitor sharedInstance].handle) {
            ...
            [DDZombieMonitor sharedInstance].handle(NSStringFromClass(self.realClass), self, selectorName, deallocStackInfo, zombieStackInfo);
        }
    }
